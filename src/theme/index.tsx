...
import { cssStringFromTheme } from './helper/css/cssStringFromTheme'
import { darkTheme } from './helper/darkTheme'
import { lightTheme } from './helper/lightTheme'
...
function uniswapThemeColors(darkMode: boolean): ThemeColors {
  return {
    ...
    backgroundSurfaceSwap: darkMode ? colorsDark.backgroundSurfaceSwap : colorsLight.backgroundSurfaceSwap,
    backgroundModule: darkMode ? colorsDark.backgroundModule : colorsLight.backgroundModule,
    backgroundModuleNew: darkMode ? colorsDark.backgroundModuleNew : colorsLight.backgroundModuleNew,
