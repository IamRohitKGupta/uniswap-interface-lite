...
export const colorsLight: Palette = {
  ...
  backgroundSurfaceSwap: opacify(40, colors.white),
  backgroundModule: colors.gray50,
  backgroundModuleNew: opacify(60, colors.gray100),
  ...
  accentActionSoft: opacify(36, colors.white),
...
export const colorsDark: Palette = {
  ...
  backgroundSurfaceSwap: opacify(40, colors.gray900),
  backgroundModule: colors.gray800,
  backgroundModuleNew: opacify(60, colors.gray800),
  ...
  accentActionSoft: opacify(36, colors.black),
  accentActiveSoft: opacify(24, colors.blue400),
  accentSuccessSoft: opacify(24, colors.green400),
  accentWarningSoft: opacify(24, colors.gold200),
  accentFailureSoft: opacify(12, colors.red400),
