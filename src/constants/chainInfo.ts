...
import bnbCircleLogoUrl from '../assets/images/bnb-circle-32.png'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  */
  [SupportedChainId.BSC]: {
    ...
    docs: 'https://docs.bnbchain.org/docs/bnbIntro',
    explorer: 'https://www.bscscan.com/',
    infoLink: 'https://info.turbineswap.com/#/bsc/',
    label: 'BSC',
    logoUrl: bnbLogo,
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://info.turbineswap.com/#/arbitrum/',
    label: 'Arbitrum',
    logoUrl: arbitrumLogoUrl,
    circleLogoUrl: arbitrumCircleLogoUrl,
    helpCenterUrl: 'https://t.me/TurbineSwap',
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
...
export const MAINNET_INFO = CHAIN_INFO[SupportedChainId.ARBITRUM_ONE]
